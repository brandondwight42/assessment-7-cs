function findLongestWord(str) {
  ...
  //The function findLongestWord is a linear or O(n) runtime because it is dependent on the "n" amount of words found in the string that is passed into the function findLongestWord.  I used https://ed.devmountain.com/materials/exercises/assessment-cs/ in preparing this solution.